...
function RightBox(props){
    ...
    return(
        ...
        <div className='fmiddleBox'>
          ...
          <div className='middleBox'>Humidity<span id="humidity">{props.humidity} %</span><div id="pr"><div id="sec"></div></div></div>
          </div>
          <div className='fsmiddleBox'>
          <div className='smiddleBox'>Visibility <span id="visibility">{props.visibility} miles</span>
          </div>
